...
namespace FigmaSharp
{
    public static class LoaderExtensions
    {
        ...
        //public static void LoadFigmaFromContent(this UIView contentView, string figmaContent, out List<IImageViewWrapper> figmaImageViews)
        //{
        //    figmaImageViews = new List<IImageViewWrapper>();
        //    var figmaDialog = FigmaApiHelper.GetFigmaResponseFromContent(figmaContent);
        ...
        //public static void LoadFigmaFromFrameEntity(this UIView view, FigmaResponse response, List<IImageViewWrapper> figmaImageViews, int page = 0)
        //{
        //    if (response != null)
        //    {
        //        LoadFigma(view, new FigmaFrameEntityResponse(response, page), figmaImageViews);
        //    }
        //    else
        //    {
        //        var alert = new UIAlertView();
        //        alert.Message = string.Format("You figma file does not have a view name:'{0}'", page);
