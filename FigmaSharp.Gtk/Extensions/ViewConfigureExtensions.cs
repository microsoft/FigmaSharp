...
namespace FigmaSharp
{
    public static class ViewConfigureExtensions
    {
        public static void Configure(this Widget view, FigmaFrameEntity child)
        {
            ...
            if (view is Box box)
            {
                box.ModifyBg(StateType.Active, child.backgroundColor.ToGdkColor());
            }
        }
        ...
        public static void Configure(this Widget figmaLineView, FigmaLine figmaLine)
        {
        ...
        public static void Configure(this Label label, FigmaText text)
        {
            ...
            //if (fills != null)
            //{
            //    label.Markup = FigmaExtensions.ToNSColor(fills.color);
            //}
